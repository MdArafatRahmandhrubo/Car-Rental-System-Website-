                ...
                <div class="col-lg-4">
                    <div class="left-content">
                        <div class="inner-content">
                            <h4>CarBook</h4>
                            <h6>This website can run car rental business</h6>
                            <div class="main-white-button scroll-to-section">
                                <a href="/bookcar">Make A Reservation</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="left-text-content">
                        <div class="section-heading">
                            <h6>About Us</h6>
                            <h2>PREMIUM CAR RENTAL FROM CHALAO RENT A CAR</h2>
                        </div>
                        <p>it is about your comfort</p>
                        <div class="row">
                            <div class="col-4">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="chef-item">
                        ...
                        <div class="down-content">
                            <h4>Arafat Rahman2</h4>
                            <span>again some review </span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="chef-item">
                        ...
                        <div class="down-content">
                            <h4>Arafat Rahman3</h4>
                            <span>again another review</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <footer>
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-xs-12">
                    <div class="left-text-content">
                        <p>© Copyright carbook & Co.
                        
                        <br>book car from here</p>
                    </div>
                </div>
            </div>
        </div>
